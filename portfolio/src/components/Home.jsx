    ...
    <div name="home" className="w-full h-screen bg-slate-800">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full ">
        ...
        <p className="text-[#8892b0] py-4 mx-w-[700px] ">
          ...
          React,Angular, or Vue.js. I am proficient in server-side programming
          and database management, creating robust APIs and ensuring seamless
          communication between systems.
        </p>
        <div>
            <button className='text-white  group border-2 px-6 py-3 my-2 flex items-center hover:bg-yellow-500 hover:border-yellow-500' type="button">View Projects <span className='group-hover:rotate-90 duration-300'><HiArrowNarrowRight  className='ml-3 '/></span></button>
        </div>
      </div>
    </div>
  );
